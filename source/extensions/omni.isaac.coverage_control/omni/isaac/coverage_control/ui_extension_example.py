...
def some_public_function(x: int):
    print("[omni.isaac.coverage_control] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[omni.isaac.coverage_control] startup")
    ...
    def on_shutdown(self):
        print("[omni.isaac.coverage_control] shutdown")
