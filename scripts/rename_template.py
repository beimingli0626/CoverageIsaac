...
It renames all the occurrences of coveragecontrol (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the coveragecontrol folder
        os.rename(
            os.path.join(root_dir_path, "exts", "coveragecontrol", "coveragecontrol"),
            os.path.join(root_dir_path, "exts", "coveragecontrol", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "coveragecontrol"), os.path.join(root_dir_path, "exts", new_name))
