...
It renames all the occurrences of omni.isaac.coverage_control (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    old_name = "omni.isaac.coverage_control"
    new_name = sys.argv[1]
    ...
    if proceed.lower() == "y":
        # rename the omni.isaac.coverage_control folder
        os.rename(
            os.path.join(root_dir_path, "source/extensions", "omni.isaac.coverage_control", "omni.isaac.coverage_control"),
            os.path.join(root_dir_path, "source/extensions", "omni.isaac.coverage_control", new_name),
        )
        os.rename(os.path.join(root_dir_path, "source/extensions", "omni.isaac.coverage_control"), os.path.join(root_dir_path, "source/extensions", new_name))
